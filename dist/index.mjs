//#region maintenance-warning-snackbar/src/lib/maintenance-warning-snackbar.ts
var e = class {
	options;
	constructor(e) {
	...
	async initialize() {
		let e = Date.now(), t = await (await fetch(this.options.jsonURL)).json();
	...
	showMaintenanceWarning(e) {
		...
		t.innerHTML = e, t.id = "maintenance-warning-snackbar", document.body.appendChild(t);
		let n = document.createElement("button");
		n.className = "maintenance-warning-snackbar-close-button", n.innerHTML = "X", n.onclick = () => {
			t.className = t.className.replace("show", "");
		}, t.appendChild(n), t.className = "show", setTimeout(() => {
			t.className = t.className.replace("show", "");
		}, 1e4);
	}
}, t = class {
...
//#endregion
export { t as MaintenanceWarningOptions, e as MaintenanceWarningSnackbar };
